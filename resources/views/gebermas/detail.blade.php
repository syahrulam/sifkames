...
<div class="container-fluid px-0">
    ...
    <div class="position-relative" style="height: 350px; background: url('{{ asset($activity->image) }}') center/cover;">
        ...
        <div class="position-absolute top-50 start-50 translate-middle text-white text-center">
            ...
            <p class="mt-2"><i class="bi bi-person"></i> Admin &nbsp; | &nbsp; <i class="bi bi-calendar"></i> {{ \Carbon\Carbon::parse($activity->date)->format('d M Y') }}</p>
        </div>
    </div>
    ...
    <div class="container mt-4">
        ...
        <!-- Tombol Kembali -->
         <div class="text-center mt-5 mb-5">
            <a href="{{ route('gebermas.index') }}" class="btn btn-primary px-4 py-2 rounded-pill shadow">
