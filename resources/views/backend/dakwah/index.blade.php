                        ...
                        <tbody>
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <!-- Tombol Edit -->
                                        <a href="{{ route('admin.dakwah.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>

                                        <!-- Form Tombol Delete -->
                                        <form action="{{ route('admin.dakwah.destroy', $item->id) }}" method="POST" style="display:inline-block;" id="delete-form-{{ $item->id }}">
                                            @csrf
                                            @method('DELETE')
